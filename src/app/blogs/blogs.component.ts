...
export class BlogsComponent implements OnInit {
  ...
  bloglist: blg[]=[
    ...
    {id:111,topicname:["Tree","Binary Search Tree","Depth First Search","Binary Tree"],name:"Recover Binary Serarch Tree",desc:"You are given the root of a binary search tree (BST), where the values of exactly two nodes of the tree were swapped by mistake.",rlink:"recoverbst"}
  ]
  constructor() { }
